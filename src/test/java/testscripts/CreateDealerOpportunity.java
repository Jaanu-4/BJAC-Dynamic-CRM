...
public class CreateDealerOpportunity extends CreateDealerAcc {
	...
	void createDealerOpportunityTest() throws InterruptedException, IOException {
		...
		log.info("****Creating Dealer Opportunity****");
		...
		log.info("****Creating the New Vehicle is Saved Succesfully****");
...
//		vehicleDocs.put("LIEN Release", 			"C:\\Automation_Photos_Docs\\LIEN Release.jpg");
		...
		log.info("****Creating the Dealer Opportunity is Saved Successfully****");
	}
}
